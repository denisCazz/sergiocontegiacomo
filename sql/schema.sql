...
CREATE INDEX IF NOT EXISTS gallery_images_public_idx ON public.gallery_images(is_published, display_order);
...
-- Contact requests (modulo contatti, gestito dal sito)
